...
require_once "../vista/cargarNumeros.php";
...
<form name="frmlistar" id="frmlistar" enctype="multipart/form-data" accept-charset="utf-8"  method="post">
    ...
    <h5 class="card-header">
      <a type="button" name="nuevo" id="nuevo" class="btn btn-info btn-sm" onclick="javascript:nuevoOdontograma(); ">Nuevo</a>


      
     <button type="button" name ="guardar" id="guardar" class="btn btn-success btn-sm" onclick="javascript:guardarOdontograma();">Guardar</button>
...
<div class="col-12 col-md-12">
  <div class="form-group">
     <label for="especificaciones">Especificaciones:</label>
          ...
          <textarea type="text" class="form-control" style="resize:none" id="especificaciones" rows="3"name="especificaciones"></textarea>
...
<div class="col-12 col-md-12">
  <div class="form-group">
     <label for="observaciones">Observaciones:</label>
          ...
          <textarea type="text" class="form-control" style="resize:none" id="observaciones" rows="3"name="observaciones"></textarea>
          <div class="valid-input invalid-feedback"></div>
          </div>
    </div>
</div>
